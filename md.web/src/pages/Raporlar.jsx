  ...
  const renderProduction = () => {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
        ...
        <div className="card" style={{ margin: 0 }}>
          <div className="card-header"><h4 className="card-title"><StatusIcon icon="📊" style={{ fontSize: 18, marginRight: 6, verticalAlign: 'middle' }} />Üretim Türü Karşılaştırması</h4></div>
          <div className="card-body" style={{ padding: 0 }}>
            <ReportTable
              columns={[
  ...
  const renderFinance = () => {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
        ...
        <div className="card" style={{ margin: 0 }}>
          <div className="card-header"><h4 className="card-title"><StatusIcon icon="📊" style={{ fontSize: 18, marginRight: 6, verticalAlign: 'middle' }} />Tahsilat Oranı</h4></div>
          <div className="card-body">
        ...
        {paymentBreakdown?.length > 0 && (
          <div className="card" style={{ margin: 0 }}>
            <div className="card-header"><h4 className="card-title"><StatusIcon icon="💳" style={{ fontSize: 18, marginRight: 6, verticalAlign: 'middle' }} />Ödeme Tipi Dağılımı</h4></div>
            <div className="card-body">
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: 16 }}>
        ...
        {byMonth?.length > 0 && (
          <div className="card" style={{ margin: 0 }}>
            <div className="card-header"><h4 className="card-title"><StatusIcon icon="📈" style={{ fontSize: 18, marginRight: 6, verticalAlign: 'middle' }} />Aylık Ciro &amp; Tahsilat</h4></div>
            <div className="card-body" style={{ padding: 0 }}>
              <ReportTable
                columns={[
        ...
        <div className="card" style={{ margin: 0 }}>
          <div className="card-header"><h4 className="card-title"><StatusIcon icon="⚠️" style={{ fontSize: 18, marginRight: 6, verticalAlign: 'middle' }} />En Yüksek Bakiyeli İşler</h4></div>
          <div className="card-body" style={{ padding: 0 }}>
            <ReportTable
              columns={[
                { label: 'İş', accessor: 'title', width: '180px' },
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
        ...
        {delayedOrders?.length > 0 && (
          <div>
            <h4 style={{ marginBottom: 12, color: '#b45309', display: 'flex', alignItems: 'center', gap: 6 }}><StatusIcon icon="⏱️" style={{ fontSize: 18 }} /> Geciken Siparişler</h4>
            <ReportTable
              columns={[
        ...
        {problemOrders?.length > 0 && (
          <div>
            <h4 style={{ marginBottom: 12, color: '#dc2626', display: 'flex', alignItems: 'center', gap: 6 }}><StatusIcon icon="⚠️" style={{ fontSize: 18 }} /> Sorunlu Teslimatlar</h4>
            <ReportTable
              columns={[
                { label: 'Sipariş', accessor: 'orderId', width: '100px' },
                { label: 'Tip', width: '80px', render: (row) => orderTypeLabels[row.orderType] || row.orderType },
        ...
        <div style={{ padding: 16, background: summary.onTimeRate >= 80 ? '#dcfce7' : '#fef9c3', borderRadius: 8, border: `1px solid ${summary.onTimeRate >= 80 ? '#86efac' : '#fde047'}` }}>
          <strong style={{ display: 'flex', alignItems: 'center', gap: 4 }}><StatusIcon icon="📋" style={{ fontSize: 16 }} /> Değerlendirme:</strong>
  ...
  return (
    <div>
      ...
      <PageHeader 
        ...
        actions={<button className="btn btn-primary no-print" onClick={handlePrint}><StatusIcon icon="print" style={{ fontSize: 16, marginRight: 4, verticalAlign: 'middle' }} /> Yazdır</button>}
      />
      ...
      {loading ? (
        ...
        <div className="card" style={{ padding: 20, border: '1px solid var(--color-danger)' }}>
          <div style={{ color: 'var(--color-danger)', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 6 }}><StatusIcon icon="❌" style={{ fontSize: 16 }} /> Hata: {error}</div>
        </div>
      ) : (
        <>
      ...
      <Modal
        ...
        title={<><StatusIcon icon="🚚" style={{ fontSize: 20, marginRight: 8, verticalAlign: 'middle' }} />Tedarikçi Performans Detayı</>}
        size="lg"
      >
      ...
      <Modal
        ...
        title={<><StatusIcon icon="👤" style={{ fontSize: 20, marginRight: 8, verticalAlign: 'middle' }} />Personel Performans Detayı</>}
        size="lg"
      >
        {personnelDetailData ? (
          personnelDetailData.error ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              {/* Personel Bilgileri */}
              <div className="card" style={{ margin: 0 }}>
                <div className="card-header"><h4 className="card-title"><StatusIcon icon="📋" style={{ fontSize: 18, marginRight: 6, verticalAlign: 'middle' }} />Personel Bilgileri</h4></div>
                <div className="card-body">
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16 }}>
                    ...
                    <div><strong>Durum:</strong> {personnelDetailData.person?.active ? <><StatusIcon icon="✅" style={{ fontSize: 14, verticalAlign: 'middle' }} /> Aktif</> : <><StatusIcon icon="⏳" style={{ fontSize: 14, verticalAlign: 'middle' }} /> Pasif</>}</div>
              ...
              {personnelDetailData.assemblyTasks?.length > 0 && (
                <div className="card" style={{ margin: 0 }}>
                  <div className="card-header"><h4 className="card-title"><StatusIcon icon="🏗️" style={{ fontSize: 18, marginRight: 6, verticalAlign: 'middle' }} />Son Montaj Görevleri</h4></div>
                  <div className="card-body" style={{ padding: 0 }}>
                          ...
                          <tr key={idx}>
                            ...
                            <td>
                              <span className={`badge badge-${task.status === 'completed' ? 'success' : task.status === 'in_progress' ? 'warning' : 'secondary'}`}>
                                {task.status === 'completed' ? <><StatusIcon icon="✅" style={{ fontSize: 14, verticalAlign: 'middle' }} /> Tamamlandı</> : task.status === 'in_progress' ? <><StatusIcon icon="🔄" style={{ fontSize: 14, verticalAlign: 'middle' }} /> Devam</> : <><StatusIcon icon="⏳" style={{ fontSize: 14, verticalAlign: 'middle' }} /> Beklemede</>}
                              </span>
                            </td>
              ...
              {personnelDetailData.issues?.length > 0 && (
                <div className="card" style={{ margin: 0 }}>
                  <div className="card-header"><h4 className="card-title"><StatusIcon icon="⚠️" style={{ fontSize: 18, marginRight: 6, verticalAlign: 'middle' }} />Atfedilen Sorunlar</h4></div>
                  <div className="card-body" style={{ padding: 0 }}>
                    <table className="report-table" style={{ width: '100%' }}>
      ...
      <Modal
        ...
        title={<><StatusIcon icon="👤" style={{ fontSize: 20, marginRight: 8, verticalAlign: 'middle' }} />Müşteri Detayı</>}
        size="lg"
      >
        {customerDetailData ? (
          customerDetailData.error ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              {/* Müşteri Bilgileri */}
              <div className="card" style={{ margin: 0 }}>
                <div className="card-header"><h4 className="card-title"><StatusIcon icon="📋" style={{ fontSize: 18, marginRight: 6, verticalAlign: 'middle' }} />Müşteri Bilgileri</h4></div>
                <div className="card-body">
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 16 }}>
              ...
              {customerDetailData.jobs?.length > 0 && (
                <div className="card" style={{ margin: 0 }}>
                  <div className="card-header"><h4 className="card-title"><StatusIcon icon="📋" style={{ fontSize: 18, marginRight: 6, verticalAlign: 'middle' }} />İşler</h4></div>
                  <div className="card-body" style={{ padding: 0 }}>
                    <table className="report-table" style={{ width: '100%' }}>
                      <thead>
                        <tr>
              ...
              {customerDetailData.payments?.length > 0 && (
                <div className="card" style={{ margin: 0 }}>
                  <div className="card-header"><h4 className="card-title"><StatusIcon icon="💰" style={{ fontSize: 18, marginRight: 6, verticalAlign: 'middle' }} />Son Ödemeler</h4></div>
                  <div className="card-body" style={{ padding: 0 }}>
                    <table className="report-table" style={{ width: '100%' }}>
                      <thead>
                        <tr>
